...
paulista = WorkSpace.create(user: marcio, name: "Paulista Work", price: 123, description: "Show", address: "Av. Paulista, 2073, Sao Paulo")
...
sumare = WorkSpace.create(user: carlos, name: "Sumare Work", price: 1111, description: "Estranho", address: "Av. Purpurina, 89, Sao Paulo")
